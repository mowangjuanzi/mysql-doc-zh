...
This is the Reference Manual for the MySQL Database System, version 8.0, through release 8.0.18. Differences between minor versions of MySQL 8.0 are noted in the present text with reference to release numbers (8.0.***x***). For license information, see the [Legal Notices](#legal-notices).
